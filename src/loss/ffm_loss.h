...
/*
 ...
 This file defines the loss of field-aware factorization machine.
 */

#ifndef _F2M_LOSS_FFM_LOSS_H
#define _F2M_LOSS_FFM_LOSS_H
...
namespace f2m {
   ...
   public:
      FFMLoss (RegularType regu_type) : Loss(regu_type) {}
      ~FFMLoss () {}
